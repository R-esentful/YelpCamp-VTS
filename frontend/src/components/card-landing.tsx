  ...
  return (
    <div className={`p-12 border border-gray-400 rounded-xl ${className}`}>
      <p className="text-center text-xl">
        ...
        My boredom for working in the office can be paid off with natural views and more things
        <svg
          className="ml-auto"
          stroke="currentColor"
          fill="#EB5524"
      ...
      <p className="text-center mt-6 font-bold text-lg">Ragnar Lothbrok</p>
    </div>
  );
}
